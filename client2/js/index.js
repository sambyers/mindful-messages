...
window.onload = function() {
    ...
    if (sessionStorage.getItem('session') && url.includes('messages.html')) {
    ...
    else if (sessionStorage.getItem('session') && url.includes('index.html')) {
        let sessionId = sessionStorage.getItem('session')
        let username = sessionStorage.getItem('username')
        if (username) {
            setLogoutButton(sessionId, 'wbxLoginBtn')
    ...
    else if (sessionStorage.getItem('session') && url.includes('about.html')) {
        let sessionId = sessionStorage.getItem('session')
        let username = sessionStorage.getItem('username')
        if (username) {
            setLogoutButton(sessionId, 'wbxLoginBtn')
    ...
    else if (url.includes('index.html?session=')) {
