...
There are two important variables to set at the top of the ```js/index.js``` file called ```baseApiUrl``` and ```rootUrl```. Set the former to the API Gateway URL with any routes appended and the latter to the root URL of the website itself.
